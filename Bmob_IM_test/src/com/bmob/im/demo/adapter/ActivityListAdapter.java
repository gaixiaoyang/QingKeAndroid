...
public class ActivityListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = LayoutInflater.from(context).inflate(R.layout.item_activitylist, null);
			holder = new ViewHolder();
			holder.root = (RelativeLayout) convertView.findViewById(R.id.activity_item_layout_root);
			holder.avatar = (ImageView) convertView.findViewById(R.id.activity_item_iv_avatar);
			holder.time = (HandyTextView) convertView.findViewById(R.id.activity_item_htv_time);
			holder.name = (HandyTextView) convertView.findViewById(R.id.activity_item_htv_name);
			holder.content = (EmoticonsTextView) convertView.findViewById(R.id.activity_item_etv_content);
			holder.contentImage = (ImageView) convertView.findViewById(R.id.activity_item_iv_content);
			holder.comment = (LinearLayout) convertView.findViewById(R.id.activity_item_ib_more);
			holder.comment.setTag(getItem(position).get("id"));
			holder.site1 = (HandyTextView) convertView.findViewById(R.id.activity_item_htv_site1);
			holder.site2 = (HandyTextView) convertView.findViewById(R.id.activity_item_htv_site2);
		...
		// if (Activity.getContentImage() == null) {
		holder.contentImage.setVisibility(View.GONE);
		// } else {
		// holder.contentImage.setVisibility(View.VISIBLE);
		// holder.contentImage.setImageBitmap(mApplication.getStatusPhoto(Activity.getContentImage()));
		// }
		...
		holder.comment.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View view) {
				final ProgressDialog progress = new ProgressDialog(ActivityListAdapter.this.context);
				...
				query.getObject(ActivityListAdapter.this.context, id, new GetListener<User>() {
					@Override
					public void onSuccess(User user) {
						Intent intent = new Intent(ActivityListAdapter.this.context, SetMyInfoActivity.class);
					...
					public void onFailure(int code, String msg) {
						Toast.makeText(ActivityListAdapter.this.context, "请检查网络", Toast.LENGTH_SHORT).show();
						progress.dismiss();
					}
				});
			}
		...
		/*holder.more.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				LinearLayout nameView = (LinearLayout) view;
				String id = nameView.getTag().toString();
				AlertDialog.Builder builder = new Builder(ActivityListAdapter.this.context);
